...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.priority-0 {
...
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,uBAAuB;AAC3B;;AAEA;IACI,wBAAwB;AAC5B;;AAEA;IACI,qBAAqB;AACzB","sourcesContent":[".priority-0 {\n    background-color: green;\n}\n\n.priority-1 {\n    background-color: yellow;\n}\n\n.priority-2 {\n    background-color: red;\n}"],"sourceRoot":""}]);
// Exports
...
function Task(data) {
    ...
    this.timeCreated = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date().getTime(), "M/d/y H:mm");
};
...
newProjectButton.addEventListener('click', function initiateNewProject() {
    let project = (0,_project_js__WEBPACK_IMPORTED_MODULE_3__.newProject)();
    if (project) {
        //Put project on the screen
        const projectDiv = (0,_display_js__WEBPACK_IMPORTED_MODULE_1__.createParentDiv)(project);
        const taskButton = (0,_display_js__WEBPACK_IMPORTED_MODULE_1__.newTaskButton)(projectDiv, project.id);
