...
newProjectButton.addEventListener('click', () => {
    ...
    if (project) {
        let task = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.newTask)();
...
formButton.addEventListener('click', _form_js__WEBPACK_IMPORTED_MODULE_4__.openForm);
