...
const getTaskProps = function() {
    ...
    if (title) {
        ...
        let dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.toDate)(new Date().getTime()), 'M/d/y p')
...
const formatDate = function() {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(date, "M/d/y");
}
...
newProjectButton.addEventListener('click', function initiateNewProject() {
    ...
    if (project) {
        ...
        const taskButton = (0,_display_js__WEBPACK_IMPORTED_MODULE_1__.newTaskButton)(projectDiv);
...
const initiateNewTask = function(taskButton) {
    taskButton.addEventListener('click', () => {
        ...
        submitButton.addEventListener('click', (e) => {
            e.preventDefault();
            let data = (0,_form_js__WEBPACK_IMPORTED_MODULE_4__.getFormData)()
            console.log(data);
